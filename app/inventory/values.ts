...
export const OPPORTUNITY_NAMES: string[] = [
  "TCC Technology", "Brooks Brothers", "Café Rio", "G8 Education",  
  "e-Government Center of Moldova",   "Metrobank Card Corporation", 
  "Saber Healthcare", "MediaTek",  "HSB", "Atma Jaya Catholic University of Indonesia", 
  "Dell EMC", "EFES Rus", "State of Louisiana",  "SUZHOU GAS GROUP CO., LTD", 
  "Smithfield Foods", "Thekking", "City of North Las Vegas",
  "Oregon State University", "Telekom Malaysia"
];
